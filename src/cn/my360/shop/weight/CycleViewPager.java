...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	public void setData(List<ImageView> views, List<PicInfo> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<PicInfo> list, ImageCycleViewListener listener, int showPosition) {
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(PicInfo info, int postion, View imageView);
	}
}